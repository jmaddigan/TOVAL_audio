...
public:
    ...
    TOVAL_ERROR TOVAL_Effect_get(uint16_t moduleID, uint16_t paramID, uint16_t datalength, void* data);
    ...
    TOVAL_ERROR set_config(size_t data_length, const void *config_data);
